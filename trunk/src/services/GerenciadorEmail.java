...
import services.GAEMailSender;
import smtp.IMailSender;
import smtp.MailMessage;
import utill.StringUtils;
...
public class GerenciadorEmail
{
	...
	public boolean envia(String nome, String email, String mensagem, String corpo)
	{
		...
		html += "<p>Equipe PADOCA</p>";

		html += "<p style='color:gray;font-size:9px;'>_____";
		html += "<p style='color:gray;font-size:9px;'>Este e-mail é gerado automaticamente pelo sistema de inscrições do PADOCA. Por favor, não responda a este e-mail.</p>";
